// ClaudeLLMProvider implements the locked LLMProvider interface from @loa/shared.
// It personalizes openers, classifies inbound replies into a single ReplyIntent,
...
export class ClaudeLLMProvider implements LLMProvider {
  ...
  async classifyReply(msg: Message): Promise<Intent> {
    ...
    // A refusal or a malformed tool call defaults to the safest routing bucket.
    if (res.refused) {
